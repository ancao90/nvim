...
vim.keymap.set('n', '<leader>tr', '@="0df{<C-V><ESC>f}x^==j"<CR>', { desc = 'Remove header of let!' })
...
vim.keymap.set('n', '<C-f>', function()
  local alternative_path = require 'mm'.alternate(vim.fn.expand('%'), vim.fn.expand('<cword>'))
