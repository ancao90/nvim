...
vim.keymap.set('n', '<Leader>b', "0wcWbefore<ESC><cmd>:w<CR>", { desc = 'fixing rubocop offenses: transform let! to before' })
vim.keymap.set('n', '<Leader>z', "<cmd>MaximizerToggle<CR>", { desc = "Toggle maximizer" })
vim.keymap.set('n', '<Leader>nf', '<cmd>Neotree toggle reveal<CR>', { desc = "Toggle neotree with revealing" })
